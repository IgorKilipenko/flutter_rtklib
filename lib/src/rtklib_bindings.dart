...
class strconv_t extends ffi.Struct {
  ...
  /// satellites of output ephemeris
  @ffi.Int32()
  external int stasel;
...
class rtksvr_t extends ffi.Struct {
  ...
  /// output solution options {sol1,sol2}
  @ffi.Int32()
  external int navsel;
  ...
  /// observation data {rov,base,corr}
  external nav_t nav;
  ...
  /// streams {rov,base,corr,sol1,sol2,logr,logb,logc}
