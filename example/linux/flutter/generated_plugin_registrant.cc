...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) flutter_rtklib_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "FlutterRtklibPlugin");
  flutter_rtklib_plugin_register_with_registrar(flutter_rtklib_registrar);
}
